...
const List roleDescriptions = [
  ...
  'You have no allegiance. You win if the Sniper does not shoot you at the end of the last round.',
  'You have no allegiance. You win if the Sniper shoots you at the end of the last round.',
  ...
  'Your have no allegiance. You win if you are able to gain leader status in a majority of the rounds. Hence, you would have to be leader 2 times in a 3 round game.',
